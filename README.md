...
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.92
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.92
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.92
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.92
    depends_on:
      - backend
