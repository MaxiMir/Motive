...
```shell
docker build -t maximir/frontend:1.0.70 .
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.70
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.70
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.70
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.70
    depends_on:
      - backend
