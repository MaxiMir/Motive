```shell
docker build -t maximir/frontend:1.0.47 .
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.47
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.47
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.47
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.47
    depends_on:
      - backend
