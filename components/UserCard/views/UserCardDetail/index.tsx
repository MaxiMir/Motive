...
import UserCardCharacteristic from './components/UserCardCharacteristic'
import UserCardEmptyGoals from './components/UserCardEmptyGoals'

const UserCardAddGoal = dynamic(() => import('./components/UserCardAddGoal'))
