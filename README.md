```shell
docker build -t maximir/frontend:1.0.30 .
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.30
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.30
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.30
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.30
    depends_on:
      - backend
