```shell
docker build -t maximir/frontend:1.0.51 .
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.51
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.51
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.51
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.51
    depends_on:
      - backend
