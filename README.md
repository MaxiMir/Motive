```shell
docker build -t maximir/frontend:1.0.17 .
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.17
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.17
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.17
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.17
    depends_on:
      - backend
