```shell
docker build -t maximir/frontend:1.0.49 .
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.49
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.49
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.49
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.49
    depends_on:
      - backend
