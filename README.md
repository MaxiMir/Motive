```shell
docker build -t maximir/frontend:1.0.48 .
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.48
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.48
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.48
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.48
    depends_on:
      - backend
