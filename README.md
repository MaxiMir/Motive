```shell
docker build -t maximir/frontend:1.0.46 .
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.46
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.46
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.46
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.46
    depends_on:
      - backend
