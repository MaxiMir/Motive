...
export default function Controls({ goal, owner, forTomorrow, clientOwnership }: ViewerProps & OwnerProps): JSX.Element {
  if (!clientOwnership.goal) {
    return <Viewer goal={goal} owner={owner} clientOwnership={clientOwnership} />
  }
