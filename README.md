```shell
docker build -t maximir/frontend:1.0.59 .
# artifactory:
docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/frontend:1.0.59
docker push maximir.jfrog.io/default-docker-virtual/frontend:1.0.59
docker pull maximir.jfrog.io/default-docker-virtual/frontend:1.0.59
...
services:
  frontend:
    image: maximir.jfrog.io/default-docker-virtual/frontend:1.0.59
    depends_on:
      - backend
